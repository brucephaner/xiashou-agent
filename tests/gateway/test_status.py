...
class TestGatewayPidState:
    ...
    def test_get_running_pid_removes_stale_pid_when_windows_kill_probe_errors(self, tmp_path, monkeypatch):
        monkeypatch.setenv("HERMES_HOME", str(tmp_path))
        pid_path = tmp_path / "gateway.pid"
        pid_path.write_text(json.dumps({
            "pid": 99999,
        ...
        def boom(_pid, _sig):
            raise SystemError("[WinError 87] The parameter is incorrect")
